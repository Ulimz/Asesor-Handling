                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className={`absolute top-full mt-2 bg-slate-900/95 backdrop-blur-xl rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] border border-white/10 overflow-hidden z-50 max-h-64 overflow-y-auto scrollbar-thin ${compact ? 'right-0 w-64 max-w-[90vw]' : 'left-0 right-0'}`}
                        >
